...
namespace NyAppWP
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            // App Local DB settings initialization
            initAppDBSettings();

            //App Network Detector
            InitAppNetwork();
        ...
        private void initAppDBSettings()
        {
            SQLLiteDBSettings.InitAppDBSettings();
        }
        ...
        {
            DeviceNetworkInformation.NetworkAvailabilityChanged += (o, e) =>
            {
