...
namespace NyAppWP.Pages.Camera
{
    ...
    /// </summary>
    public abstract class ArrayParameter : CameraParameter, IReadOnlyCollection<ArrayParameterOption>
    {
        ...
        public override void Save()
        {
            ...
            {
                if ((string)CameraDataContext.Settings[ParameterSettingName] != SelectedOption.Name)
                {
                    CameraDataContext.Settings[ParameterSettingName] = SelectedOption.Name;
                }
            }
            else
            {
                CameraDataContext.Settings.Add(ParameterSettingName, SelectedOption.Name);
            }
        }
        ...
        public override bool Load()
        {
            ...
            if (CameraDataContext.Settings.Contains(ParameterSettingName))
            {
                string name = CameraDataContext.Settings[ParameterSettingName].ToString();
